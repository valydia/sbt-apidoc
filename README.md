...
|            `apidocVersion` |  `Option[String]` |   same as `version` value    | Version of your project - supported (major.minor.patch). If not set, uses the same as the `version` setting key if it uses [Semantic Versioning][semver] compliant or 0.0.0. |
